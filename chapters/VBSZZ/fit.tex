...
The results of fitting to \llll final state are presented in table~\ref{tab:fit_result}. %and the combined channel are presented in table~\ref{tab:fit_result}.
